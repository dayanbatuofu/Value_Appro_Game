...
if __name__ == '__main__':
    ...
    # ckpt_path = './model/tanh/model_pinn_' + str(policy[N_choice]) + '_tanh.pth'
    ...
    if save_data:
        ...
        # save_path = 'closed_loop/tanh/closedloop_traj_pinn_initial_' + str(policy[N_choice]) + '_tanh.mat'
        ...
        # save_path = 'closed_loop/tanh/closedloop_traj_pinn_expanded_' + str(policy[N_choice]) + '_tanh.mat'
