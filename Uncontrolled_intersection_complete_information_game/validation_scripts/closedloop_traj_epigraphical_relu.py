...
if __name__ == '__main__':
    ...
    ckpt_path = './model/relu/model_epigraphical_' + str(policy[N_choice]) + '_relu.pth'
    activation = 'relu'
    ...
    if save_data:
        save_path = 'closed_loop/relu/closedloop_traj_epigraphical_initial_' + str(policy[N_choice]) + '_relu.mat'
        # save_path = 'closed_loop/relu/closedloop_traj_epigraphical_expanded_' + str(policy[N_choice]) + '_relu.mat'
