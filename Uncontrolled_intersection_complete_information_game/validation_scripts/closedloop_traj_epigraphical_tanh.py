...
if __name__ == '__main__':
    ...
    ckpt_path = './model/tanh/model_epigraphical_' + str(policy[N_choice]) + '_tanh.pth'
    activation = 'tanh'
    ...
    if save_data:
        save_path = 'closed_loop/tanh/closedloop_traj_epigraphical_initial_' + str(policy[N_choice]) + '_tanh.mat'
        # save_path = 'closed_loop/tanh/closedloop_traj_epigraphical_expanded_' + str(policy[N_choice]) + '_tanh.mat'
