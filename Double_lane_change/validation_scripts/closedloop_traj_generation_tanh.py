...
if __name__ == '__main__':
    ...
    # ckpt_path = './model/tanh/model_valuehardening_lane_tanh.pth'
    activation = 'tanh'
    alpha = 1
    ...
    if save_data:
        save_path = 'closed_loop/tanh/closedloop_traj_hybrid_lane_tanh.mat'
        # save_path = 'closed_loop/new/closedloop_traj_supervised_lane_tanh.mat'
        # save_path = 'closed_loop/tanh/closedloop_traj_pinn_lane_tanh.mat'
        # save_path = 'closed_loop/tanh/closedloop_traj_valuehardening_lane_tanh.mat'
