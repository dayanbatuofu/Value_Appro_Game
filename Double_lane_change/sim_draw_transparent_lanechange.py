...
class VisUtils:
    ...
    def draw_frame(self):
        ...
        for k in range(steps - 1):
            ...
            for i in range(n_agents):
                ...
                if i == 0:
                    pos = (80 - pos_x, pos_y)  # car position
    ...
    def generate(self, data):
        ...
        X = data['X']
        while time <= 4:  # SSL, SL, GT, HL, EL: 4.0
            while t[0][i] <= time:
                i += 1
            """
        ...
        # only for HJ PDE
        for i in range(26-8):
            X_bar[0][i + 8] = X_bar[0][9]
            X_bar[1][i + 8] = X_bar[1][9]
            X_bar[2][i + 8] = X_bar[2][9]
            X_bar[3][i + 8] = X_bar[3][9]
            Omega_bar[0][i + 8] = Omega_bar[0][9]
            Omega_bar[1][i + 8] = Omega_bar[1][9]
