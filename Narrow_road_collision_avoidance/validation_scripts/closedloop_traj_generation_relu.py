...
if __name__ == '__main__':
    ...
    ckpt_path = './model/relu/model_hybrid_narrowroad_relu.pth'
    # ckpt_path = './model/relu/model_supervised_narrowroad_relu.pth'
    # ckpt_path = './model/relu/model_pinn_narrowroad_relu.pth'
    # ckpt_path = './model/relu/model_valuehardening_narrowroad_relu.pth'
    activation = 'relu'
    ...
    if save_data:
        save_path = 'closed_loop/relu/closedloop_traj_hybrid_narrowroad_relu.mat'
        # save_path = 'closed_loop/relu/closedloop_traj_supervised_narrowroad_relu.mat'
        # save_path = 'closed_loop/relu/closedloop_traj_pinn_narrowroad_relu.mat'
        # save_path = 'closed_loop/relu/closedloop_traj_valuehardening_narrowroad_relu.mat'
