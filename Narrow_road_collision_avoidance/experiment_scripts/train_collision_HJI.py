...
if Epigraphical == True:
    ...
    model = modules_adaptive.SingleBVPNet(in_features=9, out_features=1, type=opt.model, mode=opt.mode,
    ...
    path = 'experiment_HJI_' + opt.model + '_el_HD' + '/'
...
if PINN == True:
    ...
    path = 'experiment_HJI_' + opt.model + '_pinn_HD' + '/'
    root_path = os.path.join(opt.logging_root, path)
